...
/* Клининговый центр
Клининговый центр
1. Реализовать метод cleanAllApartaments. Для каждого объекта из apartaments:
...
public class Solution{
    ...
    {
        for (Apartament l : apartaments)
        {
            if (l instanceof Apt1Room) ((Apt1Room) l).clean1Room();
            if (l instanceof Apt2Room) ((Apt2Room) l).clean2Rooms();
            if (l instanceof Apt3Room) ((Apt3Room) l).clean3Rooms();
        }
    }
