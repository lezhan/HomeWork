...
public class Solution {
    ...
    public static void reset() throws IOException
    {
        ...
        String sParam = bufferedReader.readLine();
        if (sParam.equals("helicopter")) result = new Helicopter();
        if (sParam.equals("plane")) {
            int iParam = bufferedReader.read();
            result = new Plane(iParam);
        }
    }
}
