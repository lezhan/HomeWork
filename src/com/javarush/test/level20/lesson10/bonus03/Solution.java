...
/* ++++ Кроссворд  - реалізувати метод detectAllWords
...
//                {'p', 'o', 'e', 'e', 'j', 'j'}
//        };
//        List<Word> w = detectAllWords(crossword, "home", "same");
//        for (Word word : w)
...
////                        System.out.println("home ==>>>   " + charsWord[0] + " ..  " + charsWord[charsWord.length - 1]);
//                    }
//                }
//            }
//
...
//                for (int j = 0; j < crossword[i].length; j++)
//                {
//                    if (charsWord[charsWord.length - 1] == crossword[i][j])
//                    {
//                        lastX = j;
//                        lastY = i;
////                        System.out.println("lastX = " + lastX + "        lastY = " + lastY);
////                        System.out.println("    same ==>>>   " + charsWord[0] + " ..  " + charsWord[charsWord.length - 1]);
//                    }
//                }
//                if ((Math.abs(firstX - lastX) == wordLenght - 1) | (Math.abs(firstY - lastY) == wordLenght - 1))
//                {
//                    Word word1 = new Word(word);
//                    word1.setStartPoint(firstX, firstY);
//                    word1.setEndPoint(lastX, lastY);
//                    wordList.add(word1);
//                }
//            }
//        }
