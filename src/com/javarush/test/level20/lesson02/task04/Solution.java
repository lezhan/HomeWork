...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (classWithStatic.i != loadedObject.i) System.out.println("CwS_i = " + classWithStatic.i + "            LO_i = " + loadedObject.i);
            if (classWithStatic.j != loadedObject.j) System.out.println("CwS_j = " + classWithStatic.j + "            LO_j = " + loadedObject.j);
